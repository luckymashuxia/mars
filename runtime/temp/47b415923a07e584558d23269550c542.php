...
<td><?php echo show_title($vo['manager_id'],'manager','username'); ?></td>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_7419__=1;$__FOR_END_7419__=9;for($i=$__FOR_START_7419__;$i < $__FOR_END_7419__;$i+=1){ ?>
