...
<div class="panel panel-default">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="姓名" name="username" value="<?php echo isset($vo['username']) ? $vo['username'] :  ''; ?>"  required>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" placeholder="生日" name="birthday" value="<?php echo isset($vo['birthday']) ? $vo['birthday'] :  ''; ?>"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd  HH:mm:ss'})" >
            </div>
        </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_26853__=1;$__FOR_END_26853__=9;for($i=$__FOR_START_26853__;$i < $__FOR_END_26853__;$i+=1){ ?>
