                                             ...
                                             <div class="col-sm-8 whh-inline">
                                              <?php if(is_array($acitem['1']) || $acitem['1'] instanceof \think\Collection): if( count($acitem['1'])==0 ) : echo "" ;else: foreach($acitem['1'] as $itemname=>$itemkey): ?>  
                                               <div class="ckbox ckbox-primary checkbox-inline" style="padding-top:0;">
                                                  <input type="checkbox" name="model[<?php echo $fmodel; ?>][]" <?php if((isset($acldata['rules'][$fmodel])) AND (array_keys($acldata['rules'][$fmodel],$itemkey))): ?>checked="checked" <?php endif; if($itemkey == 'board'): ?>checked="checked"<?php endif; ?>class="check" value="<?php echo $itemkey; ?>" id="<?php echo $fmodel; ?><?php echo $itemkey; ?>" />
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_20676__=1;$__FOR_END_20676__=9;for($i=$__FOR_START_20676__;$i < $__FOR_END_20676__;$i+=1){ ?>
