...
<section>
 ...
 <div class="panel panel-default">
         <div class="panel-heading" style="border-bottom:none;">
              <div>
              <a class="btn btn-primary" href="<?php echo url('console/Webtype/create'); ?>" style="float:right;">添加</a> 
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_15685__=1;$__FOR_END_15685__=9;for($i=$__FOR_START_15685__;$i < $__FOR_END_15685__;$i+=1){ ?>
