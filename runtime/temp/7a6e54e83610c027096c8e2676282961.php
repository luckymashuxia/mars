        ...
        <div class="panel-body panel-body-nopadding">
              <form class="form-horizontal form-bordered" id="submitForm" action="" method="post" > 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" placeholder="销售价格" id="saleprice" name="saleprice" value="<?php echo isset($vo['saleprice']) ? $vo['saleprice'] :  ''; ?>"  required>
                        </div>
                        <label class="col-sm-2 control-label"><span>*</span>市场价格：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" placeholder="市场价格" id="marketprice" name="marketprice" value="<?php echo isset($vo['marketprice']) ? $vo['marketprice'] :  ''; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_8893__=1;$__FOR_END_8893__=9;for($i=$__FOR_START_8893__;$i < $__FOR_END_8893__;$i+=1){ ?>
