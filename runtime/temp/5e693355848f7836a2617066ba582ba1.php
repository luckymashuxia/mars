        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <select class="form-control" name="city" id="city" onchange="GetRegion(this.value,2)" required>
                    ...
                    <?php if(isset($vo['cityname'])): ?>
                    <option value="<?php echo $vo['city']; ?>" selected><?php echo $vo['cityname']; ?></option>
                    <?php endif; ?>
            </select>
          </div>
          <div class="col-sm-2">
            <select class="form-control" name="area" id="area" required>
                    ...
                    <?php if(isset($vo['areaname'])): ?>
                    <option value="<?php echo $vo['area']; ?>" selected><?php echo $vo['areaname']; ?></option>
                    <?php endif; ?>
            </select>
          </div>
        </div>
...
$(document).ready(function() {
    ...
    $("[name='prov']").find("[value='<?php echo isset($vo['prov']) ? $vo['prov'] :  ''; ?>']").attr("selected", true);
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-6 avatar-size">
                        ...
                        <?php $__FOR_START_2057__=1;$__FOR_END_2057__=9;for($i=$__FOR_START_2057__;$i < $__FOR_END_2057__;$i+=1){ ?>
