<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\project2017\mx6.0\public/../application/home\view\contact\index.html";i:1495164356;s:69:"E:\project2017\mx6.0\public/../application/home\view\public\base.html";i:1495164550;s:68:"E:\project2017\mx6.0\public/../application/home\view\public\top.html";i:1495164639;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
              ...
              <ul class="contact-left">
                <li class="contact-box-item">
                  <div class="contact_item">
                    ...
                    <p class="contact_item--text">
                      <strong><?php echo get_conf('web_hotline'); ?></strong>,
                      <br><?php echo get_conf('web_hotline_more'); ?>
                    </p>
                  </div>
                </li>
                <li class="contact-item">
                  <div class="contact_item">
                    ...
                    <p class="contact_item--text">
                      <?php echo get_conf('web_email'); ?>
                       <br/><?php echo get_conf('web_email_more'); ?>
                    </p>
                  </div>
                </li>
                <li class="contact-item">
                  <div class="contact_item">
                    ...
                    <p class="contact_item--text">
                      <?php echo get_conf('web_address'); ?>
                       <br/><?php echo get_conf('web_address_more'); ?>
                    </p>
                  </div>
                </li>
              </ul>
